...
import com.bnviewpager.viewpageriteminbnv.View.FragmentDalam1;
import com.bnviewpager.viewpageriteminbnv.View.FragmentDalam2;
...
public class InnerViewPager extends Fragment {
    ...
    public static class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position == 0){
                return FragmentDalam1.newInstance();
            }
            else {
                return FragmentDalam2.newInstance();
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            if(position == 0){
                return FragmentDalam1.PAGE_TITLE;
            }
            else {
                return FragmentDalam2.PAGE_TITLE;
            }
        }
    }
}
